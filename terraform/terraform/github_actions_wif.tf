...
resource "google_iam_workload_identity_pool_provider" "github_actions" {
  ...
  attribute_condition = "assertion.sub == 'repo:shiron-dev/melisia:ref:refs/heads/main' || assertion.sub == 'repo:shiron-dev/melisia:environment:production-plan' || assertion.sub == 'repo:shiron-dev/melisia:environment:production' || (attribute.repository == 'shiron-dev/melisia' && attribute.event_name == 'merge_group' && attribute.job_workflow_ref == 'shiron-dev/melisia/.github/workflows/secret-strength-linter.yml@refs/heads/main')"
